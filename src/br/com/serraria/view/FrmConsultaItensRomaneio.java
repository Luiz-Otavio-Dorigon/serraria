...
public final class FrmConsultaItensRomaneio extends javax.swing.JInternalFrame {
    ...
    public void atualizaTela(int numero) {
        ...
        tbGrid.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    }
    ...
    private ItensRomaneio getModelSelecionado() {
        ...
        if (linha >= 0) {
            ...
            itens.setNumeroRomaneio((int) tbGrid.getValueAt(linha, 1));
            itens.setProCodigo((int) tbGrid.getValueAt(linha, 2));
            ...
            itens.setValorUnit((float) tbGrid.getValueAt(linha, 8));
            itens.setNumPecas((int) tbGrid.getValueAt(linha, 9));
    ...
    public void alteraRomaneio() {
        ...
        float total = romaneioValores.getValorTotal();
        ...
        float totalAlterado = romaneioVlr.getValorTotal();
