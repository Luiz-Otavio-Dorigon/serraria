...
import produto.view.FrmConsultaProduto;
...
public class FrmNovoItemRomaneio extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form FrmNovoItemRomaneio
     */
    ...
    private boolean finalizar() {
        ...
        if (pago >= 0) {
            ...
            if (inseriu) {
                ...
                int totalPecas = totais.getPecas_total() + Integer.parseInt(edtTotalPecas.getText());
                totalMetros = totais.getMetros_total() + totalMetros;
                
                ItensRomaneioDB novaMedia = new ItensRomaneioDB();
                totalMedia = novaMedia.getMedia(codigoRomaneio);
                
                totalValor = totais.getValor_total() + totalValor;
                totalPago = totais.getValor_pago() + totalPago;
