...
public class FrmAlteraItens extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form FrmAlteraItens
     */
    ...
    public void setModel(ItensRomaneio model) {
        ...
        Produto produto = produtodb.getConsultar(model.getCodigo_produto());
        ...
        edtNumero.setText(String.valueOf(model.getNumero_romaneio()));
        edtSequencia.setText(String.valueOf(model.getSequencia()));
        proCodigo.setText(String.valueOf(model.getCodigo_produto()));
        edtDescricao.setText(String.valueOf(model.getProduto()));
        edtValor.setText(String.valueOf(model.getValor_unit()));
        edtPecas.setText(String.valueOf(model.getNum_pecas()));
