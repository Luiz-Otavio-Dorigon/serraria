...
public class ItensRomaneioDB {
    ...
    public boolean alteraItens(ItensRomaneio itensRomaneio) {
        ...
        try {
            ...
            pstmt.setInt(1, itensRomaneio.getCodigo_produto());
            pstmt.setFloat(2, itensRomaneio.getValor_unit());
            ...
            pstmt.setInt(6, itensRomaneio.getNum_pecas());
            ...
            pstmt.setInt(11, itensRomaneio.getNumero_romaneio());
    ...
    public boolean insereItensRomaneio(ItensRomaneio novoItensRomaneio) {
        ...
        try {
            ...
            pstmt.setInt(1, novoItensRomaneio.getNumero_romaneio());
            pstmt.setInt(2, novoItensRomaneio.getSequencia());
            pstmt.setInt(3, novoItensRomaneio.getCodigo_produto());
            pstmt.setFloat(4, novoItensRomaneio.getValor_unit());
            ...
            pstmt.setInt(8, novoItensRomaneio.getNum_pecas());
